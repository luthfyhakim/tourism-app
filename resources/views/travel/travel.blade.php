...
<html lang="en">
  ...
  <body>
      ...
      <div class="container h-100">
        <div class="row h-100">
          <div class="col hero-tagline my-auto me-auto">
            <h1 class="fw-bold fs-1 text-white text-center">TRAVEL DESTINATION</h1>
            <p class="fw-normal pb-3 fs-6 text-center" style="position: relative; bottom: 30px; left: 55px">Discover Indonesia</p>
          </div>
        </div>
      </div>
    </section>
    ...
    <!-- content -->
    <section id="travel-destination" class="bg-secondary bg-opacity-10">
      <div class="container">
        <div class="row">
          <div class="row row-cols-1 row-cols-md-2 g-4" style="margin-bottom: 500px">
                ...
                <div class="row g-0">
                  ...
                  <div class="col-6 p-3">
                    <div class="card-body">
                      ...
                      <a class="text-decoration-none py-1" style="font-size: 12px" href="#">More Detail<i class="fa-solid fa-arrow-right"></i></a>
                      <p class="card-text pt-4">
                        <a class="text-decoration-none fw-bold" style="font-size: 11px" href="#"><i class="fa-solid fa-location-dot mr-2 me-2"></i>Central Kalimantan Indonesia</a>
                      </p>
                    </div>
                  </div>
                </div>
            ...
            <div class="col">
              <div class="card mb-3" style="width: 588; height: 410; box-shadow: 0px 4px 4px rgba(0, 0, 0, 0.25); border-radius: 10px">
                <div class="row g-0">
                  <div class="col-md-6">
                    <img src="Assets/traveldestination/Rectangle 19 (1).png" class="img-fluid rounded-start" alt="..." />
                  </div>
                  <div class="col-6 p-3">
                    <div class="card-body">
                      <h5 class="card-title fw-bold fs-5 mb-4">Bromo Tengger</h5>
            ...
            <div class="col">
              <div class="card mb-3" style="width: 588; height: 410; box-shadow: 0px 4px 4px rgba(0, 0, 0, 0.25); border-radius: 10px">
                <div class="row g-0">
                  <div class="col-md-6">
                    <img src="Assets/traveldestination/Rectangle 19 (5).png" class="img-fluid rounded-start" alt="..." />
                  </div>
                  <div class="col-6 p-3">
                    <div class="card-body">
                      <h5 class="card-title fw-bold fs-5 mb-4">Bromo Tengger</h5>
